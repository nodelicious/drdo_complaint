...
<BR>
 ...
 <form action="sortbydate2.php" method="POST"> 
...
</center><INPUT TYPE="HIDDEN" NAME="userid" VALUE="<?=$userid?>" ><INPUT TYPE="HIDDEN" NAME="userpass" VALUE="<?= $userpass?>"> <INPUT TYPE="HIDDEN" NAME="date" VALUE="<?= $datentered?>" >
<center>
