...
<html lang="en">
  <head>
   ...
   <link href="css/bootstrap-theme.min.css" rel="stylesheet">
     <link href="fonts/glyphicons-halflings-regular" rel="stylesheet">
...
<h2><big><img  src="drdo.png"  class="img-circle"><b>&nbsp;&nbsp;LASER SCIENCE AND TECHNOLOGY CENTER</b></big></h2>
...
<div class="well" style="color: black" >
  ...
  <div class="form-group" >
    ...
    <input type="text" name="username" method="POST" class="form-control"   required />
  </div><BR><br>
  <div class="form-group">
          <span class="glyphicon glyphicon-lock"></span>

    <label for="exampleInputEmail2">PASSWORD:</label>
    <input type="password" name="password" method="POST" class="form-control" required />
  </div><BR><br>
